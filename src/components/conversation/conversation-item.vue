    ...
    >
      ...
      <div class="warp">
        ...
        <div @click="forkConversation($event)">
          ...
          <i v-else :class="{'el-icon-star-on': conversation.isFork, 'fork': true}"></i></div>
      </div>
    </div>
...
export default {
  ...
  computed: {
    ...
    avatar: function() {
       if (!this.conversation.userProfile || !this.conversation.userProfile.avatar ) {
        return ''
      }
      return this.conversation.userProfile.avatar
    },
    conversationName: function() {
       return this.conversation.userProfile.nick || this.conversation.userProfile.nick 
    },
    messageForShow() {
  ...
  methods: {
    forkConversation(e) {
      ...
      console.log('forkConversation')
       this.$store.dispatch(
          'forkConversation', {conversationID:  this.conversation.conversationID,
